        ...
        <div className="grid grid-cols-1 gap-4 mb-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          ...
          {hasAdminAccess && (
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white">Kelola Siswa</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">Tambah & kelola data siswa</p>
            </Link>
          )}
